...
mamba create -n ADiT python=3.10 -c defaults
mamba activate ADiT
...
mamba install -y ase==3.23.0 -c conda-forge
mamba install -y matminer==0.9.2 -c conda-forge
mamba install -y smact==2.6 -c conda-forge
mamba install -y openbabel==3.1.1 -c conda-forge
